...
namespace Multiplayer.Client
{
    ...
    public class RemoteData
    {
        ...
        public static RemoteData FromNet(ServerJoinDataPacket packet)
        {
            ...
            foreach (var mod in packet.ServerInitData)
            {
                ...
                {
                    packageId = mod.packageIdNonUnique,
                    name = mod.name,
                    steamId = mod.publishedFileId,
                ...
                if (mod.config.HasValue)
                {
                    ...
                    remoteInfo.remoteModConfigs.Add(
                        new ModConfig(modInfo.packageId, modConfig.fileName, SyncConfigs.Normalize(modConfig.contents)));
                }
            }
    ...
    public struct ModFile
    {
        ...
        public override int GetHashCode() =>
            Gen.HashCombineInt(StableHash.StringInt32(relPath), unchecked((int)hash));
    }
